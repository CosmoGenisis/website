      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-end md:space-x-12 lg:space-x-16 xl:space-x-20 md:w-1/2 lg:w-2/5 xl:w-1/3 space-y-6 md:space-y-0">
        <div>
          ...
          <ul className="space-y-1 text-white">
            ...
            <li><Link to="/job-seekers" className="hover:text-white">Job Seekers</Link></li>
        ...
        <div>
          ...
          <div className="flex space-x-3 mt-1">
            ...
            <a
              href="https://www.linkedin.com/search/results/all/?fetchDeterministicClustersOnly=true&heroEntityKey=urn%3Ali%3Aorganization%3A105364490&keywords=zordie%20ai&origin=RICH_QUERY_SUGGESTION&position=0&searchId=8b4c82fc-e6b5-49ec-9d24-9ec693b60711&sid=EHn&spellCorrectionEnabled=false"
              aria-label="LinkedIn"
