...
export default function HeroSmarterHiring({
  ...
  return (
    ...
    >
      ...
      />
      {/* Content */}
      <div className="relative z-10 flex flex-col md:flex-row w-full max-w-7xl mx-auto items-center justify-between px-4 md:px-12 py-10 md:py-20">
        {/* Left side */}
        <div className="flex flex-col gap-6 max-w-xl w-full md:w-1/2">
          <h1 className="text-3xl md:text-5xl font-bold text-black mb-2 leading-tight">{title}</h1>
          <p className="text-lg md:text-2xl font-medium text-gray-800 mb-8">{subtitle}</p>
          <button
            className="px-6 md:px-8 py-3 md:py-4 rounded-full bg-black text-white text-lg md:text-xl font-medium shadow hover:bg-gray-900 transition w-fit border-2 border-white"
