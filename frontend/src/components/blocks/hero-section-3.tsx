...
import { Quote, Star, ArrowLeft, Sparkles } from 'lucide-react'
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <main className="min-h-screen overflow-hidden">
                <section>
                    <div className="relative min-h-screen flex flex-col justify-center items-center pt-24 pb-4 overflow-hidden">
                        <div
                        ...
                        <div className="mx-auto max-w-5xl px-6 w-full">
                            <div className="sm:mx-auto lg:mr-auto flex flex-col items-center text-center">
                                ...
                                >
                                    <span className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-black border border-border backdrop-blur-sm mb-6">
                                        <span className="text-lg font-medium text-muted-foreground text-white"> Essential Solutions for Success</span>
                                    </span>
                                    <h1
                                        className="max-w-4xl text-balance text-5xl font-bold md:text-6xl ">
                                        Unlock Your Potential with Our Seamless Solutions
                                    </h1>
                                    <p
                                        className="mt-4 max-w-4xl text-pretty text-lg md:text-xl">
                                        Whether you’re a business or a job seeker, discover tools designed to help you grow, achieve, and thrive—no limits, just opportunity.
                                    </p>
                                </AnimatedGroup>
                            </div>
                        </div>
    ...
    return (
        <header>
            {/* <nav
                ...
                className={cn('group fixed z-20 w-full border-b transition-colors duration-150 bg-white', scrolled && 'bg-white md:bg-background/50 backdrop-blur-3xl')}>
...
const LogoCloud = () => {
    return (
        <section className="pb-16 md:pb-32 bg-[#fce9db]">
