                    ...
                    <div className="relative w-full flex flex-col items-center justify-start p-0 m-0 bg-transparent">
                        ...
                        <div className="mx-auto max-w-5xl px-6 w-full z-10 relative">
                            <div className="sm:mx-auto lg:mr-auto flex flex-col items-center text-center">
                                ...
                                >
                                    <h1
                                        className="max-w-4xl text-balance text-5xl font-bold md:text-6xl mt-32 ">
                                        Smarter Hiring for a Brighter Future <span className='text-primary'>with Zordie AI</span>
                                    </h1>
                                    <p
                                        className="mt-4 max-w-4xl text-pretty text-lg md:text-xl">
                                        Transform your hiring process with intelligent agents that streamline every step, from screening to onboarding. Experience speed, fairness and innovation—no barriers, just results.
                                    </p>
